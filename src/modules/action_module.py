...
def main():
    ...
    #action_generation.talker("Greetings to Germany!")    
    action_generation.posture.applyPosture("Sit", 1.0)
    #action_generation.onCallPoint(-8, 3, -2)
    #action_generation.onCallPoint(-8, 3, -2)
    #action_generation.posture.applyPosture("Sit", 1.0)
    #action_generation.nodding()
    #action_generation.shaking_head()

    #action_generation.talker("Hello colleague. Please help me with my task.")
