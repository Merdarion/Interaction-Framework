...
tmux split-window -h
tmux send-keys -t bident 'ros2 run rtsp_stream video_gaze_publisher' C-m
...
tmux split-window -h
tmux send-keys -t bident 'ros2 run input_fusion input_fusion' C-m
...
# Split horizontally again for keyboard input publisher
tmux select-pane -t 5
tmux split-window -h
tmux send-keys -t bident 'ros2 run keyboard_input keyboard_publisher' C-m
